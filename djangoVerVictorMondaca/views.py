...
from djangoVerVictorMondaca.models import Productos, Clientes
from djangoVerVictorMondaca.form import ProductoRegistroForm, ClienteRegistroForm
...
def home(request):
    ...
    return render(request, 'djangoVerVictorMondaca/index.html', data)

def productosData(request):
    productos = Productos.objects.all()
    data = {'productos': productos}
    return render(request, 'djangoVerVictorMondaca/productos.html', data)
...
def crearProducto(request):
    ...
    return render(request, 'djangoVerVictorMondaca/productoRegistro.html', data)
...
def clientesData(request):
    ...
    return render(request, 'djangoVerVictorMondaca/clientes.html', data)
...
def crearCliente(request):
    ...
    return render(request, 'djangoVerVictorMondaca/clienteRegistro.html', data)
